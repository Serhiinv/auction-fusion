                ...
                <div className="w-full px-4 md:px-8 py-2">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-7xl mx-auto mb-5">
                        {features.map((feature) => (
                            <div
                                key={feature.id}
                                className="bg-white p-2 rounded-3xl shadow-md hover:opacity-80 transition-opacity flex items-center gap-2 min-h-[140px]"
                            >
                                ...
                                <p className="w-[70%] text-gray-900 text-lg md:text-2xl leading-relaxed">
                                    {feature.text}
                                </p>
                            </div>
                        ))}
