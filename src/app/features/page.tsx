            ...
            <div className="w-full bg-blue-100 text-gray-900 flex flex-col p-20">
                ...
                <div className="w-full px-4 md:px-8 py-2">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-7xl mx-auto mb-5">
                        ...
                        <div
                            className="bg-white p-2 rounded-3xl shadow-md hover:opacity-80 transition-opacity flex items-center gap-2">
                            <div className="w-[30%] flex-shrink-0">
                                ...
                                >
                                    <g className="color1" style={{fill: 'var(--genially-tertiary, red)'}}>
                                        <path
                            ...
                            <p className="w-[70%] text-gray-900 text-lg md:text-2xl leading-relaxed">More consignors and
                                buyers find you on Google and AI.</p>
                        </div>
                        <div
                            className="bg-white p-2 rounded-3xl shadow-md hover:opacity-80 transition-opacity flex items-center gap-2">
                            <div className="w-[30%] flex-shrink-0">
                                ...
                                >
                                    <g className="color1" style={{fill: 'var(--genially-tertiary, red)'}}>
                                        <path className="color1"
                                              d="m86.89,53.83c-1.57-6.4-4.51-10.68-8.74-12.73-4.91-2.38-11.09-1.13-14.69,2.97-.02.03-.05.05-.07.08-.2-.24-.4-.47-.62-.7-2.73-2.95-7.09-4.85-11.22-4.37.28-1.53.43-3.09.43-4.7,0-14.33-11.66-25.99-25.99-25.99S0,20.03,0,34.36s11.66,25.99,25.99,25.99c.23,0,.45-.02.67-.03,1.95,4.76,3.93,9.52,5.93,14.26-1.15-.12-2.31-.21-3.47-.21h-.03c-4.19,0-7.28,1.2-9.18,3.57-2.34,2.9-2.43,7.39-.24,10.91,1.8,2.88,4.62,4.64,6.88,5.86,6.95,3.73,14.94,5.71,22.86,5.71,1.2,0,2.4-.05,3.59-.14,1.93-.15,3.37-1.83,3.22-3.76-.15-1.93-1.83-3.36-3.76-3.22-7.73.6-15.76-1.09-22.6-4.76-1.5-.8-3.33-1.91-4.25-3.39-.6-.96-.71-2.25-.25-2.82.49-.61,1.85-.96,3.73-.96h.02c2.3,0,4.57.33,6.78.94.26.61.52,1.23.79,1.84.57,1.32,1.86,2.11,3.21,2.11.46,0,.93-.09,1.39-.29,1.77-.77,2.59-2.83,1.83-4.6-4.59-10.63-9.1-21.47-13.4-32.19-1.01-2.52-2.15-5.37-1.93-7.91.16-1.87,1.43-3.62,2.7-3.74,1.61-.16,3.56,1.82,5.62,5.7l8.04,15.16c.71,1.57,1.53,3.03,2.3,4.41.95,1.68,3.08,2.29,4.77,1.34,1.15-.64,1.78-1.84,1.77-3.07.01-.57-.1-1.16-.39-1.7l-2.13-4.02c-.53-1.19-.94-2.39-1.11-3.59-.31-2.18.36-4.32,1.63-5.22,1.84-1.29,4.99-.16,6.67,1.66,1.24,1.34,2.13,3.09,2.82,4.94.14,2.07.78,4.1,1.95,5.87.95,1.44,2.8,1.98,4.37,1.27,1.57-.71,2.39-2.45,1.94-4.12-.37-1.34-.76-2.79-1.26-4.27.07-1.18.5-2.34,1.27-3.21,1.51-1.72,4.31-2.29,6.37-1.29,2.82,1.37,4.27,5.16,4.99,8.1,2.84,11.6-.05,24.57-7.56,33.85-1.22,1.5-.98,3.71.52,4.92.65.52,1.43.78,2.2.78,1.02,0,2.03-.44,2.72-1.3,8.85-10.95,12.27-26.25,8.92-39.92ZM29.83,30.56c-5.33.5-8.63,5.58-9.02,10.1-.37,4.2,1.17,8.04,2.4,11.12.19.48.39.96.58,1.43-9.44-1.1-16.79-9.13-16.79-18.86,0-10.47,8.52-18.99,18.99-18.99s18.99,8.52,18.99,18.99c0,2.72-.59,5.29-1.62,7.63l-1.08-2.04c-1.32-2.49-5.34-10.05-12.46-9.39Z"
                                        ></path>
                                        <path className="color1"
                                              d="m49.9,12.19c.63.48,1.37.71,2.11.71,1.06,0,2.11-.48,2.79-1.39l4.46-5.9c1.17-1.54.86-3.74-.68-4.9-1.54-1.17-3.74-.86-4.9.68l-4.46,5.9c-1.17,1.54-.86,3.74.68,4.9Z"
                                        ></path>
                                        <path className="color1"
                                              d="m56.36,17.8c.53,1.4,1.86,2.27,3.28,2.27.41,0,.82-.07,1.23-.22l10.68-4.01c1.81-.68,2.73-2.7,2.05-4.51-.68-1.81-2.7-2.73-4.51-2.05l-10.68,4.01c-1.81.68-2.73,2.7-2.05,4.51Z"
                                        ></path>
                                        <path className="color1"
                                              d="m60.33,23.95c-1.91-.31-3.7.99-4.01,2.9-.31,1.91.99,3.71,2.9,4.01l7.88,1.27c.19.03.38.05.56.05,1.69,0,3.17-1.22,3.45-2.94.31-1.91-.99-3.71-2.9-4.01l-7.88-1.27Z"
                                        ></path>
                                    </g>
                                </svg>
                            </div>
                            <p className="w-[70%] text-gray-900 text-lg md:text-2xl leading-relaxed">Better conversion
                                from first click to sold.</p>
                        </div>
                ...
                <div className="w-full px-4 md:px-8 py-2">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-7xl mx-auto mb-5">
                        ...
                        <div
                            ...
                            <p className="w-[70%] text-gray-900 text-lg md:text-2xl leading-relaxed">AI-ready.
                                Mobile-optimised. Future-proof.</p>
                        </div>
                        <div
                            className="bg-white p-2 rounded-3xl shadow-md hover:opacity-80 transition-opacity flex items-center gap-2">
                            <div className="w-[30%] flex-shrink-0">
